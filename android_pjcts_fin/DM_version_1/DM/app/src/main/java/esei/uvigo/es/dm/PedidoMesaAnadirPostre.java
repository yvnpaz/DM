...
public class PedidoMesaAnadirPostre extends Activity implements AdapterView.OnItemSelectedListener {
	int num_mesa=0;
	Button btn;
	EditText cantidad;
	SQLiteDatabase db;
	...
	public void onCreate(Bundle savedInstanceState){
		...
		setContentView(es.uvigo.esei.dm1516.p45.R.layout.pedido_mesa_anadir_postre);
    ...
    private List<String> query(){
    	try {
			...
			String mySQL ="select * from Producto where tipo='Postre' order by nombre";
