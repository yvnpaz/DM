...
public class PedidoMesaLimpiar extends Activity{
	SQLiteDatabase db;
	...
	public void onCreate(Bundle savedInstanceState){
		...
		setContentView(es.uvigo.esei.dm1516.p45.R.layout.pedido_mesa_limpiar);
		...
		try{
			...
			lv.setOnItemClickListener(new OnItemClickListener(){
				...
				public void onItemClick(AdapterView<?> parent, View view,
					...
					delete(items[position],num_mesa);
					finish();
				}
    ...
    private void delete(String valor,int num_mesa){
    	String[] whereArgs = {valor};
    	int recAffected = db.delete("Pedido", 
    			"producto=? AND mesa="+num_mesa, whereArgs);
