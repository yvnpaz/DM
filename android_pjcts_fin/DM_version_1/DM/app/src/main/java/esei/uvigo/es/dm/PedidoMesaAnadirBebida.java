...
public class PedidoMesaAnadirBebida extends Activity implements AdapterView.OnItemSelectedListener{
	int num_mesa=0;
	Button btn;
	EditText cantidad;
	SQLiteDatabase db;
	...
	public void onCreate(Bundle savedInstanceState){
		...
		setContentView(es.uvigo.esei.dm1516.p45.R.layout.pedido_mesa_anadir_bebida);
    ...
    private List<String> query(){
    	try {
			...
			String mySQL ="select * from Producto where tipo='Bebida' order by nombre";
